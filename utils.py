tvg_ids_logos = {'GOL MUNDIAL HD': 'https://i.postimg.cc/3ryZ9n8G/golmundial.png',
                 ...
                 'Barcelona TV': 'https://img.sport-tv-guide.live/images/tv-station-barca-tv-1456.png',
...
def extract_tvg_id(channel_title):
    ...
    if "BARÇA" in title or "BARCA" in title or "BARÃ§A" in title:
        ...
        if "2" in title:
            ...
            return "LaLiga TV Hypermotion 3 HD"
        elif "4" in title:
            return "LaLiga TV Hypermotion 4"
        elif "5" in title:
            return "LaLiga TV Hypermotion 5"
        elif "6" in title:
            return "LaLiga TV Hypermotion 6"
        elif "7" in title:
            return "LaLiga TV Hypermotion 7"
        elif "8" in title:
            return "LaLiga TV Hypermotion 8"
        else:
            return "LaLiga TV Hypermotion HD"
        ...
        if "2" in title:
            ...
            return "M+ LaLiga TV 3 HD"
        elif "4" in title:
            return "M+ LaLiga TV 4"
        elif "5" in title:
            return "M+ LaLiga TV 5"
        elif "6" in title:
            return "M+ LaLiga TV 6"
        else:
            return "M+ LaLiga TV HD"
